...
### Error Cost
```{r, cache=TRUE}
cost_matrix <- matrix(c(0,1,5,-5), nrow = 2) # NEED TO UPDATE COST MATRIX
cost_matrix
...
modeldata <- data.frame(
  ...
  Profit = c(cost_profit, comb_profit, 2466, 1690, 2847, 2687, 2819, 2245), # NEED TO UPDATE VALUES
  Kappa = c(round(cost_kappa, digits = 4), round(comb_kappa, digits = 4), 0.3074, 0.2276, 0.3379, 0.3255, 0.3339, 0.2855) # NEED TO UPDATE VALUES
)
